...
export const cozyDark = {
  ...
  colors: {
    ...
    "activityBar.activeFocusBorder": `${editor.limedSpruce}b3`,
    "activityBarBadge.background": common.primary.main,
    "activityBarBadge.foreground": `${common.white}99`,
    "activityBarTop.activeBorder": common.gray[50],
    "activityErrorBadge.background": common.danger,
    "activityErrorBadge.foreground": common.white,
    "activityWarningBadge.background": editor.rawSienna,
    "activityWarningBadge.foreground": common.gray[800],
    ...
    "button.border": editor.limedSpruce,
    "button.secondaryHoverBackground": `${common.white}10`,
    "chat.requestBubbleBackground": `${common.white}0d`,
    "chat.requestBubbleHoverBackground": `${common.white}18`,
    "charts.foreground": common.gray[100],
    "charts.lines": `${common.gray[100]}80`,
    "charts.blue": editor.dodgerBlue2,
    "charts.red": common.danger,
    "charts.yellow": common.yellow,
    "charts.orange": editor.rawSienna,
    "charts.green": common.green,
    "charts.purple": syntax.mediumPurple,
    "checkbox.background": common.gray[700],
    "checkbox.border": editor.limedSpruce,
    "checkbox.foreground": common.gray[100],
    "commandCenter.border": common.gray[700],
    "commandCenter.foreground": common.gray[100],
    "commandCenter.activeForeground": common.gray[100],
    "commandCenter.background": common.gray[800],
    "commandCenter.activeBackground": common.gray[700],
    "commandCenter.activeBorder": editor.limedSpruce,
    ...
    disabledForeground: `${common.gray[400]}99`,
    "diffEditor.insertedLineBackground": `${common.green}26`,
    "diffEditor.insertedTextBackground": `${common.green}4d`,
    "diffEditor.insertedTextBorder": editor.limedSpruce,
    "diffEditor.removedLineBackground": `${common.danger}26`,
    "diffEditor.removedTextBackground": `${common.danger}4d`,
    ...
    "editorCommentsWidget.rangeBackground": `${editor.limedSpruce}26`,
    "editorCommentsWidget.rangeActiveBackground": `${editor.limedSpruce}46`,
    ...
    "editorLineNumber.activeForeground": common.gray[100],
    ...
    "editorOverviewRuler.findMatchForeground": `${editor.dodgerBlue}99`,
    "editorOverviewRuler.modifiedForeground": `${editor.aquaForest}90`,
    "editorOverviewRuler.addedForeground": `${common.green}91`,
    "editorOverviewRuler.deletedForeground": common.danger,
    "editorOverviewRuler.errorForeground": common.danger,
    "editorOverviewRuler.warningForeground": common.yellow,
    ...
    "editorStickyScroll.background": common.gray[900],
    "editorStickyScrollHover.background": common.gray[800],
    ...
    "widget.border": editor.limedSpruce,
    ...
    "icon.foreground": common.gray[400],
    ...
    "inputOption.activeBackground": `${common.primary.main}33`,
    "inputOption.activeBorder": editor.dodgerBlue2,
    "inputOption.activeForeground": common.gray[100],
    ...
    "list.invalidItemForeground": common.gray[400],
    "list.warningForeground": common.yellow,
    "menu.background": common.gray[700],
    "menu.border": common.gray[700],
    "menu.foreground": common.silver,
    "menu.selectionForeground": common.gray[100],
    "menu.selectionBackground": common.gray[900],
    "menubar.selectionBackground": common.gray[700],
    "menubar.selectionForeground": common.gray[100],
    ...
    "gauge.foreground": editor.dodgerBlue2,
    "gauge.background": `${editor.dodgerBlue2}4d`,
    "gauge.border": common.gray[700],
    "gauge.warningForeground": common.yellow,
    "gauge.warningBackground": `${common.yellow}4d`,
    "gauge.errorForeground": common.danger,
    "gauge.errorBackground": `${common.danger}4d`,
    "notificationCenter.border": editor.limedSpruce,
    "notificationCenterHeader.background": editor.gableGreen,
    "notificationCenterHeader.foreground": common.gray[100],
    "notificationLink.foreground": common.gray[300],
    "notificationToast.border": editor.limedSpruce,
    ...
    "quickInput.background": editor.mirage2,
    "quickInput.border": editor.limedSpruce,
    "quickInput.foreground": common.gray[100],
    "quickInputList.focusBackground": editor.limedSpruce,
    "quickInputList.focusForeground": common.gray[100],
    "quickInputList.focusIconForeground": common.gray[100],
    "quickInputList.hoverBackground": common.gray[600],
    "quickInputTitle.background": common.gray[700],
    ...
    "statusBar.focusBorder": `${editor.limedSpruce}b3`,
    ...
    "terminal.border": common.gray[700],
    "terminal.selectionBackground": `${common.primary.main}33`,
    "terminal.tab.activeBorder": `${common.primary.main}00`,
    ...
    "textPreformat.background": common.gray[700],
  ...
  tokenColors: [
    ...
    {
      name: "Markup Raw / Fenced Code",
      scope: ["markup.raw", "markup.fenced_code"],
      settings: {
        foreground: common.gray[50],
      },
    },
    {
      name: "Markup Link",
    ...
    },
    {
      ...
      settings: {
        foreground: syntax.mediumPurple,
      },
    },
    {
  ...
  semanticTokenColors: {
    newOperator: syntax.viola,
    stringLiteral: syntax.myPink,
    customLiteral: syntax.sapling,
    numberLiteral: syntax.coriander,
  },
}
