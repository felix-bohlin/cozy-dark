...
export const cozyDark = {
  ...
  type: "dark",
  colors: {
    "activityBar.background": common.gray[800],
    "activityBar.border": common.gray[700],
    "activityBar.foreground": common.gray[50],
    "activityBar.inactiveForeground": `${common.silver}3d`,
    "activityBar.activeBorder": common.gray[50],
    ...
    "badge.foreground": common.gray[100],
    ...
    "dropdown.foreground": common.gray[100],
    ...
    "editorGroupHeader.tabsBackground": common.gray[800],
    "editorGroupHeader.tabsBorder": common.gray[700],
    ...
    "editorLightBulb.foreground": common.yellow,
    ...
    "editorWidget.background": common.gray[800],
    "editorWidget.border": common.gray[400],
    errorForeground: common.danger,
    "extensionButton.prominentBackground": common.primary.main,
    "extensionButton.prominentForeground": common.gray[100],
    ...
    "menu.background": common.gray[700],
    "menu.selectionForeground": common.gray[100],
    "menu.selectionBackground": common.gray[900],
    ...
    "panelTitle.activeForeground": common.silver,
    "panelTitle.activeBorder": common.silver,
    "panelTitle.inactiveForeground": common.gray[300],
    ...
    "selection.background": `${editor.apple}4d`,
    "sideBar.background": common.gray[800],
    "sideBar.border": common.gray[900],
    "sideBar.foreground": common.gray[150],
    "sideBarSectionHeader.background": common.gray[900],
    "sideBarSectionHeader.border": `${common.silver}3d`,
    "sideBarSectionHeader.foreground": common.gray[50],
    ...
    "statusBar.foreground": common.gray[50],
    ...
    "statusBarItem.remoteBackground": common.gray[800],
    "statusBarItem.remoteForeground": common.gray[100],
    "tab.activeBackground": common.gray[900],
    "tab.activeBorder": common.gray[900],
    "tab.activeForeground": common.gray[100],
    "tab.border": common.gray[800],
    "tab.inactiveBackground": common.gray[800],
    "tab.inactiveForeground": common.gray[50],
    ...
    "titleBar.activeForeground": common.gray[100],
